...
CONFIG = {
    # Your niche
    "niche": "AI tools for solo consultants and small agencies",
    "audience": "consultants and small-agency owners who run their business themselves",
    "newsletter_name": "The Solo Operator Brief",
    "newsletter_voice": (
        "Direct, no fluff. Short sentences. Skip industry jargon. "
        "Lead with the most surprising fact, not a summary. "
        "Never use 'in today's fast-paced world' or similar throat-clearing. "
        "One personal observation per issue."
    ),
    "brand_voice": (
        "Helpful and specific. Real prices, real product names. No hedging. "
        "Write like a senior practitioner explaining to a peer, not a content marketer."
    ),

    # RSS feeds to watch — replace with your niche's best sources
    "rss_feeds": [
        # Examples — replace with feeds for your niche:
        # "https://blog.example-saas.com/rss",
        # "https://news.ycombinator.com/rss",
        # "https://www.reddit.com/r/Entrepreneur/.rss",
    ],

    # Affiliate products available in this niche (name, category, url)
    "affiliate_products": [
        # {"id": "tool_a", "name": "ToolA", "category": "CRM", "url": "https://tool-a.com/?ref=YOUR_ID"},
    ],
